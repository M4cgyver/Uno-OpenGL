...
public abstract class Card implements Serializable{
	...
	protected String color = null;	// Note: This is a color object. Java has predefined libraries for colors, so we
...
class WildCard extends Card {
	...
	public void hitPlayer(Player p) {
		...
		while(true)
		{
			...
			{									
				...
				card = Integer.parseInt(sc.nextLine()) -1;
				sc.close();
				break;
				
			}catch (Exception e)
			{
				System.out.println("ERROR: You did not correctly enter an integer!");
			}
		}
	...
	public boolean isCompatible(Card c) {
		...
		return c.color.contentEquals(color);
